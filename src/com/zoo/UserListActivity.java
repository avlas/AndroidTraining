 ...
 */
public class UserListActivity extends Activity implements UserListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.user_detail_container) != null) {
			...
			((UserListFragment) getFragmentManager().findFragmentById(R.id.user_list)).setActivateOnItemClick(true);
		}
