...
import com.zoo.ListArrayAdapter;
import com.zoo.dummy.DummyContent;
...
//				android.R.layout.simple_list_item_activated_1, android.R.id.text1, DummyContent.ITEMS));
		...
		setListAdapter(new ListArrayAdapter(getActivity(), R.layout.activity_user_listitem, R.id.user_fullname, UserContent.USERS));
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		//Restore des views suite a la rotation d'ecran
